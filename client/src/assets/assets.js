...
export const testimonials = [
  {
    ...
    rating: 5,
    review:
      "ContentAI has completely transformed our content creation workflow. The quality is outstanding and it saves us hours every week."
  },
  {
    id: 2,
    name: "James Wilson",
    ...
    rating: 5,
    review:
      "The best AI writing platform we've used. It feels incredibly polished and the results are consistently impressive."
  },
  {
    id: 3,
    name: "Emily Davis",
    ...
    rating: 5,
    review:
      "Our team now produces content three times faster. The interface is beautiful and the AI quality is exceptional."
  },
  {
    id: 4,
    name: "Michael Brown",
    ...
    rating: 5,
    review:
      "Every AI tool inside this platform feels thoughtfully designed. Highly recommended."
  }
];
...
export const pricingPlans = [
...

    {
        ...
        description:
            "The perfect choice for creators and freelancers.",
