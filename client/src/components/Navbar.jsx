...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 right-0 z-50 h-20 w-full bg-white/75 backdrop-blur-xl flex justify-between items-center px-4 py-3 sm:px-20 xl:px-32 cursor-pointer'>
